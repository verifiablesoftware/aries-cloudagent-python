        ...
        if not context.settings.get("read_only_ledger"):
            ...
            if taa_info["taa_required"] and public_did:
                ...
                if (
                    ...
                    if not await accept_taa(ledger, taa_info, context.settings.get("accept_taa"), provision):
                        return False
...
async def accept_taa(ledger: BaseLedger, taa_info, default_accept_taa, provision: bool = False) -> bool:
