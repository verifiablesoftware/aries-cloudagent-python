...
class DefaultContextBuilder(ContextBuilder):
    ...
    async def bind_providers(self, context: InjectionContext):
        ...
        context.injector.bind_provider(
            ...
            StatsProvider(
                ClassProvider(
                    "aries_cloudagent_vsw.issuer.indy.IndyIssuer",
        ...
        context.injector.bind_provider(
            ...
            StatsProvider(
                ClassProvider(
                    "aries_cloudagent_vsw.holder.indy.IndyHolder",
                    ClassProvider.Inject(BaseWallet),
                ),
        ...
        context.injector.bind_provider(
            BaseVerifier,
            ClassProvider(
                "aries_cloudagent_vsw.verifier.indy.IndyVerifier",
                ClassProvider.Inject(BaseLedger),
            ),
        )
        context.injector.bind_provider(
            BaseTailsServer,
            ClassProvider("aries_cloudagent_vsw.tails.indy_tails_server.IndyTailsServer",),
        )
        ...
        context.injector.bind_provider(
            ...
            CachedProvider(
                StatsProvider(
                    ClassProvider(
                        "aries_cloudagent_vsw.transport.pack_format.PackWireFormat"
                    ),
                    (
    ...
    async def load_plugins(self, context: InjectionContext):
        ...
        plugin_registry.register_package("aries_cloudagent_vsw.protocols")

        # Currently providing admin routes only
        plugin_registry.register_plugin("aries_cloudagent_vsw.holder")
        plugin_registry.register_plugin("aries_cloudagent_vsw.ledger")
        plugin_registry.register_plugin(
            "aries_cloudagent_vsw.messaging.credential_definitions"
        )
        plugin_registry.register_plugin("aries_cloudagent_vsw.messaging.schemas")
        plugin_registry.register_plugin("aries_cloudagent_vsw.revocation")
        plugin_registry.register_plugin("aries_cloudagent_vsw.wallet")
