...
class TestIndyLedger(AsyncTestCase):
    ...
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._context_open")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._context_close")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._submit")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger.fetch_schema_by_id")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger.fetch_schema_by_seq_no")
    @async_mock.patch("aries_cloudagent_vsw.storage.indy.IndyStorage.add_record")
    ...
    @async_mock.patch("indy.pool.open_pool_ledger")
    @async_mock.patch("indy.pool.close_pool_ledger")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger.check_existing_schema")
    @async_mock.patch("aries_cloudagent_vsw.storage.indy.IndyStorage.add_record")
    @async_mock.patch("indy.ledger.build_schema_request")
    ...
    async def test_send_schema_issuer_error(
        ...
        issuer = async_mock.MagicMock(BaseIssuer)
        issuer.create_and_store_schema = async_mock.CoroutineMock(
    ...
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger.get_schema")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._context_open")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._context_close")
    @async_mock.patch(
        "aries_cloudagent_vsw.ledger.indy.IndyLedger.fetch_credential_definition"
    )
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._submit")
    @async_mock.patch("aries_cloudagent_vsw.storage.indy.IndyStorage.search_records")
    @async_mock.patch("aries_cloudagent_vsw.storage.indy.IndyStorage.add_record")
    ...
    @async_mock.patch("indy.ledger.build_get_nym_request")
    @async_mock.patch("indy.ledger.build_get_txn_request")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger.register_nym")
    @async_mock.patch("aries_cloudagent_vsw.ledger.indy.IndyLedger._submit")
