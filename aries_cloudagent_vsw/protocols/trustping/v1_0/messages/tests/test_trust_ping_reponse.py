...
class TestPingResponse(TestCase):
    ...
    @mock.patch(
        "aries_cloudagent_vsw.protocols.trustping.v1_0.messages.ping_response.PingResponseSchema.load"
    )
    ...
    @mock.patch(
        "aries_cloudagent_vsw.protocols.trustping.v1_0.messages.ping_response.PingResponseSchema.dump"
    )
