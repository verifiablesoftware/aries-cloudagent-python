...
class StorageProvider(BaseProvider):
    ...
    STORAGE_TYPES = {
        "basic": "aries_cloudagent_vsw.storage.basic.BasicStorage",
        "indy": "aries_cloudagent_vsw.storage.indy.IndyStorage",
        "postgres_storage": "aries_cloudagent_vsw.storage.indy.IndyStorage",
    }
